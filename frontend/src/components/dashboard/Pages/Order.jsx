                                    ...
                                    <div className="col">
                                        <nav className="mb-2" aria-label="breadcrumb">
                                            <ol className="breadcrumb breadcrumb-sa-simple">
                                                ...
                                                <li className="breadcrumb-item"><a href="app-orders-list.html">Orders</a></li>
                                                <li className="breadcrumb-item active" aria-current="page">Order #80294</li>
                                            </ol>
                                        </nav>
                                        <h1 className="h3 m-0">Order #80294</h1>
                                    </div>
                                    <div className="col-auto d-flex">
                                        <a href="#" className="btn btn-secondary me-3">Delete</a>
                                ...
                                <div className="sa-entity-layout__body">
                                    <div className="sa-entity-layout__main">
                                        <div className="sa-card-area">
                                            <textarea className="sa-card-area__area" rows={2} placeholder="Notes about order" defaultValue={""} />
                                            <div className="sa-card-area__card">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="feather feather-edit">
                                        ...
                                        <div className="card mt-5">
                                            <div className="card-body px-5 py-4 d-flex align-items-center justify-content-between">
                                                ...
                                                <div className="text-muted fs-exact-14"><a href="#">Edit items</a></div>
                                            </div>
                                                ...
                                                <table className="sa-table">
                                                    <tbody>
                                                        <tr>
                                                            <td className="min-w-20x">
                                                                <div className="d-flex align-items-center">
                                                                    <img src="images/products/product-2-40x40.jpg" className="me-4" width={40} height={40} alt />
                                                                    <a href="app-product.html" className="text-reset">Brandix Brake Kit BDX-750Z370-S</a>
                                                                </div>
                                                            </td>
                                                            <td className="text-end">
                                                                <div className="sa-price">
                                                                    <span className="sa-price__symbol">$</span>
                                                                    <span className="sa-price__integer">849</span>
                                                        ...
                                                        <tr>
                                                            <td className="min-w-20x">
                                                                <div className="d-flex align-items-center">
                                                                    <img src="images/products/product-7-40x40.jpg" className="me-4" width={40} height={40} alt />
                                                                    <a href="app-product.html" className="text-reset">Glossy Gray 19" Aluminium Wheel AR-19</a>
                                                                </div>
                                                            </td>
                                                            <td className="text-end">
                                                                <div className="sa-price">
                                                                    <span className="sa-price__symbol">$</span>
                                                                    <span className="sa-price__integer">699</span>
                                                                    <span className="sa-price__decimal">.00</span>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td className="text-end">
                                                                <div className="sa-price">
                                                                    <span className="sa-price__symbol">$</span>
                                                                    <span className="sa-price__integer">1,398</span>
                                                                    <span className="sa-price__decimal">.00</span>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td className="min-w-20x">
                                                                <div className="d-flex align-items-center">
                                                                    <img src="images/products/product-16-40x40.jpg" className="me-4" width={40} height={40} alt />
                                                                    <a href="app-product.html" className="text-reset">Twin Exhaust Pipe From Brandix Z54</a>
                                                                </div>
                                                            </td>
                                                            <td className="text-end">
                                                                <div className="sa-price">
                                                                    <span className="sa-price__symbol">$</span>
                                                                    <span className="sa-price__integer">1,210</span>
                                                                    <span className="sa-price__decimal">.00</span>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td className="text-end">
                                                                <div className="sa-price">
                                                                    <span className="sa-price__symbol">$</span>
                                                                    <span className="sa-price__integer">3,630</span>
                                                                    <span className="sa-price__decimal">.00</span>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    ...
                                                    <tbody className="sa-table__group">
                                                        <tr>
                                                            ...
                                                            <td className="text-end">
                                                                <div className="sa-price">
                                                                    <span className="sa-price__symbol">$</span>
                                                                    <span className="sa-price__integer">5,877</span>
                                                                    <span className="sa-price__decimal">.00</span>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td className="text-end">
                                                                <div className="sa-price">
                                                                    <span className="sa-price__symbol">$</span>
                                                                    <span className="sa-price__integer">-20</span>
                                                                    <span className="sa-price__decimal">.00</span>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td className="text-end">
                                                                <div className="sa-price">
                                                                    <span className="sa-price__symbol">$</span>
                                                                    <span className="sa-price__integer">25</span>
                                                                    <span className="sa-price__decimal">.00</span>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td className="text-end">
                                                                <div className="sa-price">
                                                                    <span className="sa-price__symbol">$</span>
                                                                    <span className="sa-price__integer">5,882</span>
                                                                    <span className="sa-price__decimal">.00</span>
                                                                </div>
                                                            </td>
                                                        </tr>
                                        ...
                                        <div className="card mt-5">
                                            <div className="card-body px-5 py-4 d-flex align-items-center justify-content-between">
                                                ...
                                                <div className="text-muted fs-exact-14"><a href="#">Add transaction</a></div>
                                            </div>
                                            <div className="table-responsive">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td className="text-end">
                                                                <div className="sa-price">
                                                                    <span className="sa-price__symbol">$</span>
                                                                    <span className="sa-price__integer">2,000</span>
                                                                    <span className="sa-price__decimal">.00</span>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td className="text-end">
                                                                <div className="sa-price">
                                                                    <span className="sa-price__symbol">$</span>
                                                                    <span className="sa-price__integer">50</span>
                                                                    <span className="sa-price__decimal">.00</span>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td className="text-end text-danger">
                                                                <div className="sa-price">
                                                                    <span className="sa-price__symbol">$</span>
                                                                    <span className="sa-price__integer">-325</span>
                                                                    <span className="sa-price__decimal">.00</span>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                ...
                                                <tbody className="sa-table__group">
                                                    <tr>
                                                        ...
                                                        <td className="text-end">
                                                            <div className="sa-price">
                                                                <span className="sa-price__symbol">$</span>
                                                                <span className="sa-price__integer">-80</span>
                                                                <span className="sa-price__decimal">.00</span>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td className="text-end">
                                                            <div className="sa-price">
                                                                <span className="sa-price__symbol">$</span>
                                                                <span className="sa-price__integer">5,802</span>
                                                                <span className="sa-price__decimal">.00</span>
                                                            </div>
                                                        </td>
                                                    </tr>
                                        ...
                                        <div className="card">
                                            ...
                                            <div className="card-body d-flex align-items-center pt-4">
                                                ...
                                                <div className="ms-3 ps-2">
                                                    <div className="fs-exact-14 fw-medium">Jessica Moore</div>
                                                    <div className="fs-exact-13 text-muted">This is a first order</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="card mt-5">
                                            ...
                                            <div className="card-body pt-4 fs-exact-14">
                                                ...
                                                <div className="mt-1"><a href="#">moore@example.com</a></div>
                                                <div className="text-muted mt-1">+38 (094) 730-24-25</div>
                                            </div>
                                        </div>
                                        <div className="card mt-5">
                                            <div className="card-body d-flex align-items-center justify-content-between pb-0 pt-4">
