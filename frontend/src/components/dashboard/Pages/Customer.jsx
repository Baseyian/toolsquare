                                    ...
                                    <div className="col">
                                        <nav className="mb-2" aria-label="breadcrumb">
                                            <ol className="breadcrumb breadcrumb-sa-simple">
                                                ...
                                                <li className="breadcrumb-item"><a href="app-customers-list.html">Customers</a></li>
                                                <li className="breadcrumb-item active" aria-current="page">Jessica Moore</li>
                                            </ol>
                                        </nav>
                                        <h1 className="h3 m-0">Jessica Moore</h1>
                                    </div>
                                ...
                                <div className="sa-entity-layout__body">
                                    <div className="sa-entity-layout__sidebar">
                                        <div className="card">
                                            <div className="card-body d-flex flex-column align-items-center">
                                                <div className="pt-3">
                                                    <div className="sa-symbol sa-symbol--shape--circle" style={{ size: '6rem' }}>
                                                        <img src="images/customers/customer-1-96x96.jpg" width={96} height={96} alt />
                                                    </div>
                                                </div>
                                    ...
                                    <div className="sa-entity-layout__main">
                                        <div className="sa-card-area">
                                            <textarea className="sa-card-area__area" rows={2} placeholder="Notes about customer" defaultValue={""} />
                                        ...
                                        <div className="card mt-5">
                                            <div className="card-body px-5 py-4 d-flex align-items-center justify-content-between">
                                                ...
                                                <div className="text-muted fs-exact-14 text-end">Total spent $34,980.34 on 7 orders</div>
                                            </div>
                                            ...
                                            <div className="px-5 py-4 text-center"><a href="app-orders-list.html">View all 7 orders</a></div>
                                        </div>
                                        <div className="card mt-5">
                                            <div className="card-body px-5 py-4 d-flex align-items-center justify-content-between">
                                                <h2 className="mb-0 fs-exact-18 me-4">Addresses</h2>
                                                <div className="text-muted fs-exact-14"><a href="#">New address</a></div>
                                            </div>
                                            <div className="sa-divider" />
                                            <div className="px-5 py-3 my-2 d-flex align-items-center justify-content-between">
                                                <div>
                                                    <div>Jessica Moore</div>
                                                    <div className="text-muted fs-exact-14 mt-1">Random Federation 115302, Moscow ul. Varshavskaya, 15-2-178</div>
                                                </div>
                                                <div>
                                                    <div className="dropdown">
                                                        <button className="btn btn-sa-muted btn-sm" type="button" id="address-context-menu-0" data-bs-toggle="dropdown" aria-expanded="false" aria-label="More">
                                                        ...
                                                        <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="address-context-menu-0">
                                            ...
                                            <div className="px-5 py-3 my-2 d-flex align-items-center justify-content-between">
                                                <div>
                                                    ...
                                                    <div className="text-muted fs-exact-14 mt-1">Earth 4b4f53, MarsGrad Sun Orbit, 43.3241-85.239</div>
                                                </div>
                                                <div>
                                                    <div className="dropdown">
                                                        <button className="btn btn-sa-muted btn-sm" type="button" id="address-context-menu-1" data-bs-toggle="dropdown" aria-expanded="false" aria-label="More">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width={3} height={13} fill="currentColor">
                                                                <path d="M1.5,8C0.7,8,0,7.3,0,6.5S0.7,5,1.5,5S3,5.7,3,6.5S2.3,8,1.5,8z M1.5,3C0.7,3,0,2.3,0,1.5S0.7,0,1.5,0 S3,0.7,3,1.5S2.3,3,1.5,3z M1.5,10C2.3,10,3,10.7,3,11.5S2.3,13,1.5,13S0,12.3,0,11.5S0.7,10,1.5,10z" />
                                                            </svg>
                                                        </button>
                                                        <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="address-context-menu-1">
                                                            <li><a className="dropdown-item" href="#">Edit</a></li>
                                                            <li><a className="dropdown-item" href="#">Duplicate</a></li>
                                                            <li><a className="dropdown-item" href="#">Add tag</a></li>
                                                            <li><a className="dropdown-item" href="#">Remove tag</a></li>
