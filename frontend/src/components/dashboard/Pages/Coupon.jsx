                                    ...
                                    <div className="col">
                                        <nav className="mb-2" aria-label="breadcrumb">
                                            <ol className="breadcrumb breadcrumb-sa-simple">
                                                ...
                                                <li className="breadcrumb-item"><a href="app-coupons-list.html">Coupons</a></li>
                                ...
                                <div className="sa-entity-layout__body">
                                    <div className="sa-entity-layout__main">
                                        <div className="card">
                                            <div className="card-body p-5">
                                                ...
                                                <div className="mb-4">
                                                    <label htmlFor="form-coupon/code" className="form-label">Code</label>
                                                ...
                                                <div className="mb-4">
                                                    <label htmlFor="form-coupon/value" className="form-label">Discount value</label>
                                                    <input type="text" className="form-control" id="form-coupon/value" defaultValue="$10.00" />
                                                </div>
                                                <div className="mb-4">
                                                    <label htmlFor="form-coupon/limit" className="form-label">Usage limit</label>
                                    ...
                                    <div className="sa-entity-layout__sidebar">
                                        <div className="card w-100">
                                            <div className="card-body p-5">
                                                <div className="mb-5"><h2 className="mb-0 fs-exact-18">Status</h2></div>
                                        ...
                                        <div className="card w-100 mt-5">
                                            <div className="card-body p-5">
                                                <div className="mb-5">
                                                    ...
                                                    <div className="mt-3 text-muted">Use these settings to limit the coupon expiration date.</div>
                                                </div>
                                                <div className="mb-4">
                                                    <label htmlFor="form-coupon/start-date" className="form-label">Start date</label>
                                                    <input type="text" className="form-control datepicker-here" id="form-coupon/start-date" data-auto-close="true" data-language="en" />
                                                </div>
                                                <div>
                                                    <label htmlFor="form-coupon/end-date" className="form-label">End date</label>
                                                    <input type="text" className="form-control datepicker-here" id="form-coupon/end-date" data-auto-close="true" data-language="en" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
