                        ...
                        <div className="py-5">
                            <div className="row g-4 align-items-center">
                                ...
                                <div className="col-auto d-flex">
                                    <a href="#" className="btn btn-secondary me-3">Import</a>
                                    <a href="app-product.html" className="btn btn-primary">New product</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="sa-layout">
                            ...
                            <div className="sa-layout__sidebar">
                                <div className="sa-layout__sidebar-header">
                                    ...
                                    <button type="button" className="sa-close sa-layout__sidebar-close" aria-label="Close" data-sa-layout-sidebar-close />
                                </div>
                                        ...
                                        <li className="sa-filters__item">
                                            ...
                                            <div className="sa-filters__item-body">
                                                <div className="sa-filter-range" data-min={0} data-max={2000} data-from={0} data-to={2000}>
                                                    ...
                                                    <input type="hidden" defaultValue={0} className="sa-filter-range__input-from" />
                                                    <input type="hidden" defaultValue={2000} className="sa-filter-range__input-to" />
                                                </div>
                                            </div>
                                        </li>
                                        <li className="sa-filters__item">
                                                ...
                                                <ul className="list-unstyled m-0 mt-n2">
                                                    <li>
                                                        <label className="d-flex align-items-center pt-2">
                                                            <input type="checkbox" className="form-check-input m-0 me-3 fs-exact-16" defaultChecked />
                                                            Power tools
                                                        </label>
                                                    </li>
                                                    <li>
                                                        <label className="d-flex align-items-center pt-2">
                                                            <input type="checkbox" className="form-check-input m-0 me-3 fs-exact-16" />
                                                            Hand tools
                                                        </label>
                                                    </li>
                                                    <li>
                                        ...
                                        <li className="sa-filters__item">
                                            ...
                                            <div className="sa-filters__item-body">
                                                <ul className="list-unstyled m-0 mt-n2">
                                                    <li>
                                                        <label className="d-flex align-items-center pt-2">
                                                            <input type="radio" className="form-check-input m-0 me-3 fs-exact-16" name="filter-product_type" defaultChecked />
                                                            Simple
                                                        </label>
                                                    </li>
                                                    <li>
                                                        <label className="d-flex align-items-center pt-2">
                                                            <input type="radio" className="form-check-input m-0 me-3 fs-exact-16" name="filter-product_type" />
                                                            Variable
                                                        </label>
                                                    </li>
                                                    <li>
                                    ...
                                    <table className="sa-datatables-init" data-order="[[ 1, &quot;asc&quot; ]]" data-sa-search-input="#table-search">
                                        ...
                                        <tbody>
                                            <tr>
                                                            ...
                                                            <div className="sa-meta mt-0">
                                                                <ul className="sa-meta__list">
                                                                    <li className="sa-meta__item">
                                                                        ID:
                                                                        <span title="Click to copy product ID" className="st-copy">2043</span>
                                                                    </li>
                                                                    <li className="sa-meta__item">
                                                                        SKU:
                                                                        <span title="Click to copy product SKU" className="st-copy">KL370090</span>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                ...
                                                <td><div className="badge badge-sa-success">25 In Stock</div></td>
                                                <td>
                                                    <div className="sa-price">
                                                        <span className="sa-price__symbol">$</span>
                                                        <span className="sa-price__integer">749</span>
                                            ...
                                            <tr>
                                                        ...
                                                        <div>
                                                            ...
                                                            <div className="sa-meta mt-0">
                                                                <ul className="sa-meta__list">
                                                                    <li className="sa-meta__item">
                                                                        ID:
                                                                        <span title="Click to copy product ID" className="st-copy">1746</span>
                                                                    </li>
                                                                    <li className="sa-meta__item">
                                                                        SKU:
                                                                        <span title="Click to copy product SKU" className="st-copy">DPS300SY</span>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                ...
                                                <td><div className="badge badge-sa-danger">Out of Stock</div></td>
                                                <td>
                                                    <div className="sa-price">
                                                        <span className="sa-price__symbol">$</span>
                                                        <span className="sa-price__integer">1,019</span>
                                                        <span className="sa-price__decimal">.00</span>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="d-flex align-items-center">
                                                        <a href="app-product.html" className="me-4">
                                                            <div className="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                                                <img src="images/products/product-3-40x40.jpg" width={40} height={40} alt />
                                                            </div>
                                                        </a>
                                                        <div>
                                                            ...
                                                            <div className="sa-meta mt-0">
                                                                <ul className="sa-meta__list">
                                                                    <li className="sa-meta__item">
                                                                        ID:
                                                                        <span title="Click to copy product ID" className="st-copy">8821</span>
                                                                    </li>
                                                                    <li className="sa-meta__item">
                                                                        SKU:
                                                                        <span title="Click to copy product SKU" className="st-copy">ALX7054B</span>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                ...
                                                <td><div className="badge badge-sa-success">3 In Stock</div></td>
                                                <td>
                                                    <div className="sa-price">
                                                        <span className="sa-price__symbol">$</span>
                                                        <span className="sa-price__integer">850</span>
                                                        <span className="sa-price__decimal">.00</span>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                        ...
                                                        <div>
                                                            ...
                                                            <div className="sa-meta mt-0">
                                                                <ul className="sa-meta__list">
                                                                    <li className="sa-meta__item">
                                                                        ID:
                                                                        <span title="Click to copy product ID" className="st-copy">5312</span>
                                                                    </li>
                                                                    <li className="sa-meta__item">
                                                                        SKU:
                                                                        <span title="Click to copy product SKU" className="st-copy">KSR4590P</span>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                ...
                                                <td><div className="badge badge-sa-success">7 In Stock</div></td>
                                                <td>
                                                    <div className="sa-price">
                                                        <span className="sa-price__symbol">$</span>
                                                        <span className="sa-price__integer">949</span>
                                                        <span className="sa-price__decimal">.00</span>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                        ...
                                                        <div>
                                                            ...
                                                            <div className="sa-meta mt-0">
                                                                <ul className="sa-meta__list">
                                                                    <li className="sa-meta__item">
                                                                        ID:
                                                                        <span title="Click to copy product ID" className="st-copy">3326</span>
                                                                    </li>
                                                                    <li className="sa-meta__item">
                                                                        SKU:
                                                                        <span title="Click to copy product SKU" className="st-copy">2017ERX9</span>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                ...
                                                <td><div className="badge badge-sa-primary">Preorder</div></td>
                                                <td>
                                                    <div className="sa-price">
                                                        <span className="sa-price__symbol">$</span>
                                                        <span className="sa-price__integer">1,700</span>
                                                        <span className="sa-price__decimal">.00</span>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                        ...
                                                        <div>
                                                            ...
                                                            <div className="sa-meta mt-0">
                                                                <ul className="sa-meta__list">
                                                                    <li className="sa-meta__item">
                                                                        ID:
                                                                        <span title="Click to copy product ID" className="st-copy">4402</span>
                                                                    </li>
                                                                    <li className="sa-meta__item">
                                                                        SKU:
                                                                        <span title="Click to copy product SKU" className="st-copy">DM2019KW</span>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                ...
                                                <td><a href="app-category.html" className="text-reset">Drills</a></td>
                                                <td><div className="badge badge-sa-warning">On Backorder</div></td>
                                                <td>
                                                    <div className="sa-price">
                                                        <span className="sa-price__symbol">$</span>
                                                        <span className="sa-price__integer">3,199</span>
                                                        <span className="sa-price__decimal">.00</span>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                        ...
                                                        <div>
                                                            ...
                                                            <div className="sa-meta mt-0">
                                                                <ul className="sa-meta__list">
                                                                    <li className="sa-meta__item">
                                                                        ID:
                                                                        <span title="Click to copy product ID" className="st-copy">9637</span>
                                                                    </li>
                                                                    <li className="sa-meta__item">
                                                                        SKU:
                                                                        <span title="Click to copy product SKU" className="st-copy">BDX100PL</span>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                ...
                                                <td><div className="badge badge-sa-success">8 In Stock</div></td>
                                                <td>
                                                    <div className="sa-price">
                                                        <span className="sa-price__symbol">$</span>
                                                        <span className="sa-price__integer">24</span>
                                                        <span className="sa-price__decimal">.00</span>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="d-flex align-items-center">
                                                        <a href="app-product.html" className="me-4">
                                                            <div className="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                                                <img src="images/products/product-8-40x40.jpg" width={40} height={40} alt />
                                                            </div>
                                                        </a>
                                                        <div>
                                                            ...
                                                            <div className="sa-meta mt-0">
                                                                <ul className="sa-meta__list">
                                                                    <li className="sa-meta__item">
                                                                        ID:
                                                                        <span title="Click to copy product ID" className="st-copy">2002</span>
                                                                    </li>
                                                                    <li className="sa-meta__item">
                                                                        SKU:
                                                                        <span title="Click to copy product SKU" className="st-copy">WATER40C</span>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                ...
                                                <td>
                                                    <div className="sa-price">
                                                        <span className="sa-price__symbol">$</span>
                                                        <span className="sa-price__integer">15</span>
                                                        <span className="sa-price__decimal">.00</span>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="d-flex align-items-center">
                                                        <a href="app-product.html" className="me-4">
                                                            <div className="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                                                <img src="images/products/product-9-40x40.jpg" width={40} height={40} alt />
                                                            </div>
                                                        </a>
                                                        <div>
                                                            ...
                                                            <div className="sa-meta mt-0">
                                                                <ul className="sa-meta__list">
                                                                    <li className="sa-meta__item">
                                                                        ID:
                                                                        <span title="Click to copy product ID" className="st-copy">4955</span>
                                                                    </li>
                                                                    <li className="sa-meta__item">
                                                                        SKU:
                                                                        <span title="Click to copy product SKU" className="st-copy">SP0072WR</span>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                ...
                                                <td><a href="app-category.html" className="text-reset">Hand Tools</a></td>
                                                <td><div className="badge badge-sa-success">15 In Stock</div></td>
                                                <td>
                                                    <div className="sa-price">
                                                        <span className="sa-price__symbol">$</span>
                                                        <span className="sa-price__integer">19</span>
                                                        <span className="sa-price__decimal">.00</span>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                        ...
                                                        <div>
                                                            ...
                                                            <div className="sa-meta mt-0">
                                                                <ul className="sa-meta__list">
                                                                    <li className="sa-meta__item">
                                                                        ID:
                                                                        <span title="Click to copy product ID" className="st-copy">6428</span>
                                                                    </li>
                                                                    <li className="sa-meta__item">
                                                                        SKU:
                                                                        <span title="Click to copy product SKU" className="st-copy">TAP883WT</span>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                ...
                                                <td><a href="app-category.html" className="text-reset">Plumbing</a></td>
                                                <td><div className="badge badge-sa-success">24 In Stock</div></td>
                                                <td>
                                                    <div className="sa-price">
                                                        <span className="sa-price__symbol">$</span>
                                                        <span className="sa-price__integer">15</span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="d-flex align-items-center">
                                                        <a href="app-product.html" className="me-4">
                                                            <div className="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                                                <img src="images/products/product-11-40x40.jpg" width={40} height={40} alt />
                                                            </div>
                                                        </a>
                                                        <div>
                                                            ...
                                                            <div className="sa-meta mt-0">
                                                                <ul className="sa-meta__list">
                                                                    <li className="sa-meta__item">
                                                                        ID:
                                                                        <span title="Click to copy product ID" className="st-copy">1302</span>
                                                                    </li>
                                                                    <li className="sa-meta__item">
                                                                        SKU:
                                                                        <span title="Click to copy product SKU" className="st-copy">HT75002K</span>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                ...
                                                <td><a href="app-category.html" className="text-reset">Hand Tools</a></td>
                                                <td><div className="badge badge-sa-success">9 In Stock</div></td>
                                                <td>
                                                    <div className="sa-price">
                                                        <span className="sa-price__symbol">$</span>
                                                        <span className="sa-price__integer">149</span>
                                                        <span className="sa-price__decimal">.00</span>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="d-flex align-items-center">
                                                        <a href="app-product.html" className="me-4">
                                                            <div className="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                                                <img src="images/products/product-12-40x40.jpg" width={40} height={40} alt />
                                                            </div>
                                                        </a>
                                                        <div>
                                                            ...
                                                            <div className="sa-meta mt-0">
                                                                <ul className="sa-meta__list">
                                                                    <li className="sa-meta__item">
                                                                        ID:
                                                                        <span title="Click to copy product ID" className="st-copy">1022</span>
                                                                    </li>
                                                                    <li className="sa-meta__item">
                                                                        SKU:
                                                                        <span title="Click to copy product SKU" className="st-copy">AC6660KW</span>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                ...
                                                <td>
                                                    <div className="sa-price">
                                                        <span className="sa-price__symbol">$</span>
                                                        <span className="sa-price__integer">666</span>
                                                        <span className="sa-price__decimal">.99</span>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div className="dropdown">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="d-flex align-items-center">
                                                        <a href="app-product.html" className="me-4">
                                                            <div className="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                                                <img src="images/products/product-13-40x40.jpg" width={40} height={40} alt />
                                                            </div>
                                                        </a>
                                                        <div>
                                                            ...
                                                            <div className="sa-meta mt-0">
                                                                <ul className="sa-meta__list">
                                                                    <li className="sa-meta__item">
                                                                        ID:
                                                                        <span title="Click to copy product ID" className="st-copy">7203</span>
                                                                    </li>
                                                                    <li className="sa-meta__item">
                                                                        SKU:
                                                                        <span title="Click to copy product SKU" className="st-copy">KZX389PQ</span>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                ...
                                                <td><a href="app-category.html" className="text-reset">Power Tools</a></td>
                                                <td><div className="badge badge-sa-success">2 In Stock</div></td>
                                                <td>
                                                    <div className="sa-price">
                                                        <span className="sa-price__symbol">$</span>
                                                        <span className="sa-price__integer">649</span>
                                                        <span className="sa-price__decimal">.00</span>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="d-flex align-items-center">
                                                        <a href="app-product.html" className="me-4">
                                                            <div className="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                                                <img src="images/products/product-14-40x40.jpg" width={40} height={40} alt />
                                                            </div>
                                                        </a>
                                                        <div>
                                                            ...
                                                            <div className="sa-meta mt-0">
                                                                <ul className="sa-meta__list">
                                                                    ...
                                                                    <li className="sa-meta__item">
                                                                        SKU:
                                                                        <span title="Click to copy product SKU" className="st-copy">DELTA500</span>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                ...
                                                <td>
                                                    <div className="sa-price">
                                                        <span className="sa-price__symbol">$</span>
                                                        <span className="sa-price__integer">1,800</span>
                                                        <span className="sa-price__decimal">.00</span>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="d-flex align-items-center">
                                                        <a href="app-product.html" className="me-4">
                                                            <div className="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                                                <img src="images/products/product-15-40x40.jpg" width={40} height={40} alt />
                                                            </div>
                                                        </a>
                                                        <div>
                                                            ...
                                                            <div className="sa-meta mt-0">
                                                                <ul className="sa-meta__list">
                                                                    <li className="sa-meta__item">
                                                                        ID:
                                                                        <span title="Click to copy product ID" className="st-copy">5221</span>
                                                                    </li>
                                                                    <li className="sa-meta__item">
                                                                        SKU:
                                                                        <span title="Click to copy product SKU" className="st-copy">JIG7000B</span>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                ...
                                                <td><a href="app-category.html" className="text-reset">Power Tools</a></td>
                                                <td><div className="badge badge-sa-success">1 In Stock</div></td>
                                                <td>
                                                    <div className="sa-price">
                                                        <span className="sa-price__symbol">$</span>
                                                        <span className="sa-price__integer">290</span>
                                                        <span className="sa-price__decimal">.00</span>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                        ...
                                                        <div>
                                                            ...
                                                            <div className="sa-meta mt-0">
                                                                <ul className="sa-meta__list">
                                                                    <li className="sa-meta__item">
                                                                        ID:
                                                                        <span title="Click to copy product ID" className="st-copy">7321</span>
                                                                    </li>
                                                                    <li className="sa-meta__item">
                                                                        SKU:
                                                                        <span title="Click to copy product SKU" className="st-copy">SCREW150</span>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                ...
                                                <td><a href="app-category.html" className="text-reset">Power Tools</a></td>
                                                <td><div className="badge badge-sa-success">18 In Stock</div></td>
                                                <td>
                                                    <div className="sa-price">
                                                        <span className="sa-price__symbol">$</span>
                                                        <span className="sa-price__integer">1,499</span>
                                                        <span className="sa-price__decimal">.00</span>
                                                    </div>
                                                </td>
                                                <td>
