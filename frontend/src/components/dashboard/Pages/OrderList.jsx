                        ...
                        <div className="container">
                            <div className="py-5">
                                <div className="row g-4 align-items-center">
                                    ...
                                    <div className="col-auto d-flex"><a href="app-order.html" className="btn btn-primary">New order</a></div>
                                </div>
                            </div>
                            <div className="card">
                                <div className="p-4">
                                    <input type="text" placeholder="Start typing to search for orders" className="form-control form-control--search mx-auto" id="table-search" />
                                </div>
                                ...
                                <table className="sa-datatables-init text-nowrap" data-order="[[ 1, &quot;desc&quot; ]]" data-sa-search-input="#table-search">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><a href="app-order.html" className="text-reset">#3201</a></td>
                                            <td>June 26, 2021</td>
                                            <td><a href="app-customer.html" className="text-reset">Jessica Moore</a></td>
                                            <td>
                                                <div className="d-flex fs-6"><div className="badge badge-sa-success">Yes</div></div>
                                            </td>
                                            <td>
                                                <div className="d-flex fs-6"><div className="badge badge-sa-danger">New</div></div>
                                            </td>
                                            <td>3 items</td>
                                            <td>
                                                <div className="sa-price">
                                                    <span className="sa-price__symbol">$</span>
                                                    <span className="sa-price__integer">200</span>
                                        ...
                                        <tr>
                                            <td><input type="checkbox" className="form-check-input m-0 fs-exact-16 d-block" aria-label="..." /></td>
                                            <td><a href="app-order.html" className="text-reset">#2091</a></td>
                                            <td>May 15, 2021</td>
                                            <td><a href="app-customer.html" className="text-reset">Helena Garcia</a></td>
                                            <td>
                                                <div className="d-flex fs-6"><div className="badge badge-sa-secondary">No</div></div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div className="sa-price">
                                                    <span className="sa-price__symbol">$</span>
                                                    <span className="sa-price__integer">5,023</span>
                                                    <span className="sa-price__decimal">.00</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div className="dropdown">
                                                    <button className="btn btn-sa-muted btn-sm" type="button" id="order-context-menu-1" data-bs-toggle="dropdown" aria-expanded="false" aria-label="More">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width={3} height={13} fill="currentColor">
                                                            <path d="M1.5,8C0.7,8,0,7.3,0,6.5S0.7,5,1.5,5S3,5.7,3,6.5S2.3,8,1.5,8z M1.5,3C0.7,3,0,2.3,0,1.5S0.7,0,1.5,0 S3,0.7,3,1.5S2.3,3,1.5,3z M1.5,10C2.3,10,3,10.7,3,11.5S2.3,13,1.5,13S0,12.3,0,11.5S0.7,10,1.5,10z" />
                                                        </svg>
                                                    </button>
                                                    <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="order-context-menu-1">
                                                        <li><a className="dropdown-item" href="#">Edit</a></li>
                                                        <li><a className="dropdown-item" href="#">Duplicate</a></li>
                                                        <li><a className="dropdown-item" href="#">Add tag</a></li>
                                                        <li><a className="dropdown-item" href="#">Remove tag</a></li>
                                        ...
                                        <tr>
                                            <td><input type="checkbox" className="form-check-input m-0 fs-exact-16 d-block" aria-label="..." /></td>
                                            <td><a href="app-order.html" className="text-reset">#1937</a></td>
                                            ...
                                            <td>
                                                <div className="d-flex fs-6"><div className="badge badge-sa-success">Shipped</div></div>
                                            </td>
                                            <td>1 items</td>
                                            <td>
                                                <div className="sa-price">
                                                    <span className="sa-price__symbol">$</span>
                                                    <span className="sa-price__integer">703</span>
                                                    <span className="sa-price__decimal">.00</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div className="dropdown">
                                                    <button className="btn btn-sa-muted btn-sm" type="button" id="order-context-menu-2" data-bs-toggle="dropdown" aria-expanded="false" aria-label="More">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width={3} height={13} fill="currentColor">
                                                            <path d="M1.5,8C0.7,8,0,7.3,0,6.5S0.7,5,1.5,5S3,5.7,3,6.5S2.3,8,1.5,8z M1.5,3C0.7,3,0,2.3,0,1.5S0.7,0,1.5,0 S3,0.7,3,1.5S2.3,3,1.5,3z M1.5,10C2.3,10,3,10.7,3,11.5S2.3,13,1.5,13S0,12.3,0,11.5S0.7,10,1.5,10z" />
                                                        </svg>
                                                    </button>
                                                    <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="order-context-menu-2">
                                                        <li><a className="dropdown-item" href="#">Edit</a></li>
                                                        <li><a className="dropdown-item" href="#">Duplicate</a></li>
                                                        <li><a className="dropdown-item" href="#">Add tag</a></li>
                                                        <li><a className="dropdown-item" href="#">Remove tag</a></li>
                                        ...
                                        <tr>
                                            <td><input type="checkbox" className="form-check-input m-0 fs-exact-16 d-block" aria-label="..." /></td>
                                            <td><a href="app-order.html" className="text-reset">#1724</a></td>
                                            <td>December 10, 2020</td>
                                            <td><a href="app-customer.html" className="text-reset">Ryan Ford</a></td>
                                            <td>
                                                <div className="d-flex fs-6"><div className="badge badge-sa-warning">Partial</div></div>
                                            </td>
                                            <td>
                                                <div className="d-flex fs-6"><div className="badge badge-sa-success">Shipped</div></div>
                                            </td>
                                            ...
                                            <td>
                                                <div className="sa-price">
                                                    <span className="sa-price__symbol">$</span>
                                                    <span className="sa-price__integer">1,200</span>
                                                    <span className="sa-price__decimal">.00</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div className="dropdown">
                                                    <button className="btn btn-sa-muted btn-sm" type="button" id="order-context-menu-3" data-bs-toggle="dropdown" aria-expanded="false" aria-label="More">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width={3} height={13} fill="currentColor">
                                                            <path d="M1.5,8C0.7,8,0,7.3,0,6.5S0.7,5,1.5,5S3,5.7,3,6.5S2.3,8,1.5,8z M1.5,3C0.7,3,0,2.3,0,1.5S0.7,0,1.5,0 S3,0.7,3,1.5S2.3,3,1.5,3z M1.5,10C2.3,10,3,10.7,3,11.5S2.3,13,1.5,13S0,12.3,0,11.5S0.7,10,1.5,10z" />
                                                        </svg>
                                                    </button>
                                                    <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="order-context-menu-3">
                                                        <li><a className="dropdown-item" href="#">Edit</a></li>
                                                        <li><a className="dropdown-item" href="#">Duplicate</a></li>
                                                        <li><a className="dropdown-item" href="#">Add tag</a></li>
                                                        <li><a className="dropdown-item" href="#">Remove tag</a></li>
                                        ...
                                        <tr>
                                            <td><input type="checkbox" className="form-check-input m-0 fs-exact-16 d-block" aria-label="..." /></td>
                                            <td><a href="app-order.html" className="text-reset">#1603</a></td>
                                            ...
                                            <td>
                                                <div className="d-flex fs-6"><div className="badge badge-sa-secondary">Canceled</div></div>
                                            </td>
                                            <td>12 items</td>
                                            <td>
                                                <div className="sa-price">
                                                    <span className="sa-price__symbol">$</span>
                                                    <span className="sa-price__integer">3,701</span>
                                                    <span className="sa-price__decimal">.00</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div className="dropdown">
                                                    <button className="btn btn-sa-muted btn-sm" type="button" id="order-context-menu-4" data-bs-toggle="dropdown" aria-expanded="false" aria-label="More">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width={3} height={13} fill="currentColor">
                                                            <path d="M1.5,8C0.7,8,0,7.3,0,6.5S0.7,5,1.5,5S3,5.7,3,6.5S2.3,8,1.5,8z M1.5,3C0.7,3,0,2.3,0,1.5S0.7,0,1.5,0 S3,0.7,3,1.5S2.3,3,1.5,3z M1.5,10C2.3,10,3,10.7,3,11.5S2.3,13,1.5,13S0,12.3,0,11.5S0.7,10,1.5,10z" />
                                                        </svg>
                                                    </button>
                                                    <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="order-context-menu-4">
                                                        <li><a className="dropdown-item" href="#">Edit</a></li>
                                                        <li><a className="dropdown-item" href="#">Duplicate</a></li>
                                                        <li><a className="dropdown-item" href="#">Add tag</a></li>
                                                        <li><a className="dropdown-item" href="#">Remove tag</a></li>
                                        ...
                                        <tr>
                                            <td><input type="checkbox" className="form-check-input m-0 fs-exact-16 d-block" aria-label="..." /></td>
                                            <td><a href="app-order.html" className="text-reset">#1544</a></td>
                                            <td>June 15, 2020</td>
                                            <td><a href="app-customer.html" className="text-reset">Olivia Smith</a></td>
                                            <td>
                                                <div className="d-flex fs-6"><div className="badge badge-sa-success">Yes</div></div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div className="sa-price">
                                                    <span className="sa-price__symbol">$</span>
                                                    <span className="sa-price__integer">127</span>
                                                    <span className="sa-price__decimal">.00</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div className="dropdown">
                                                    <button className="btn btn-sa-muted btn-sm" type="button" id="order-context-menu-5" data-bs-toggle="dropdown" aria-expanded="false" aria-label="More">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width={3} height={13} fill="currentColor">
                                                            <path d="M1.5,8C0.7,8,0,7.3,0,6.5S0.7,5,1.5,5S3,5.7,3,6.5S2.3,8,1.5,8z M1.5,3C0.7,3,0,2.3,0,1.5S0.7,0,1.5,0 S3,0.7,3,1.5S2.3,3,1.5,3z M1.5,10C2.3,10,3,10.7,3,11.5S2.3,13,1.5,13S0,12.3,0,11.5S0.7,10,1.5,10z" />
                                                        </svg>
                                                    </button>
                                                    <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="order-context-menu-5">
                                                        <li><a className="dropdown-item" href="#">Edit</a></li>
                                                        <li><a className="dropdown-item" href="#">Duplicate</a></li>
                                                        <li><a className="dropdown-item" href="#">Add tag</a></li>
                                                        <li><a className="dropdown-item" href="#">Remove tag</a></li>
                                        ...
                                        <tr>
                                            <td><input type="checkbox" className="form-check-input m-0 fs-exact-16 d-block" aria-label="..." /></td>
                                            <td><a href="app-order.html" className="text-reset">#1501</a></td>
                                            <td>May 29, 2020</td>
                                            <td><a href="app-customer.html" className="text-reset">Kevin Smith</a></td>
                                            <td>
                                                <div className="d-flex fs-6"><div className="badge badge-sa-success">Yes</div></div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div className="sa-price">
                                                    <span className="sa-price__symbol">$</span>
                                                    <span className="sa-price__integer">2,299</span>
                                                    <span className="sa-price__decimal">.00</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div className="dropdown">
                                                    <button className="btn btn-sa-muted btn-sm" type="button" id="order-context-menu-6" data-bs-toggle="dropdown" aria-expanded="false" aria-label="More">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width={3} height={13} fill="currentColor">
                                                            <path d="M1.5,8C0.7,8,0,7.3,0,6.5S0.7,5,1.5,5S3,5.7,3,6.5S2.3,8,1.5,8z M1.5,3C0.7,3,0,2.3,0,1.5S0.7,0,1.5,0 S3,0.7,3,1.5S2.3,3,1.5,3z M1.5,10C2.3,10,3,10.7,3,11.5S2.3,13,1.5,13S0,12.3,0,11.5S0.7,10,1.5,10z" />
                                                        </svg>
                                                    </button>
                                                    <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="order-context-menu-6">
                                                        <li><a className="dropdown-item" href="#">Edit</a></li>
                                                        <li><a className="dropdown-item" href="#">Duplicate</a></li>
                                                        <li><a className="dropdown-item" href="#">Add tag</a></li>
                                                        <li><a className="dropdown-item" href="#">Remove tag</a></li>
                                        ...
                                        <tr>
                                            <td><input type="checkbox" className="form-check-input m-0 fs-exact-16 d-block" aria-label="..." /></td>
                                            <td><a href="app-order.html" className="text-reset">#1429</a></td>
                                            <td>May 2, 2020</td>
                                            <td><a href="app-customer.html" className="text-reset">Charlotte Jones</a></td>
                                            <td>
                                                <div className="d-flex fs-6"><div className="badge badge-sa-warning">Partial</div></div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div className="sa-price">
                                                    <span className="sa-price__symbol">$</span>
                                                    <span className="sa-price__integer">794</span>
                                                    <span className="sa-price__decimal">.00</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div className="dropdown">
                                                    <button className="btn btn-sa-muted btn-sm" type="button" id="order-context-menu-7" data-bs-toggle="dropdown" aria-expanded="false" aria-label="More">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width={3} height={13} fill="currentColor">
                                                            <path d="M1.5,8C0.7,8,0,7.3,0,6.5S0.7,5,1.5,5S3,5.7,3,6.5S2.3,8,1.5,8z M1.5,3C0.7,3,0,2.3,0,1.5S0.7,0,1.5,0 S3,0.7,3,1.5S2.3,3,1.5,3z M1.5,10C2.3,10,3,10.7,3,11.5S2.3,13,1.5,13S0,12.3,0,11.5S0.7,10,1.5,10z" />
                                                        </svg>
                                                    </button>
                                                    <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="order-context-menu-7">
                                                        <li><a className="dropdown-item" href="#">Edit</a></li>
                                                        <li><a className="dropdown-item" href="#">Duplicate</a></li>
                                                        <li><a className="dropdown-item" href="#">Add tag</a></li>
                                                        <li><a className="dropdown-item" href="#">Remove tag</a></li>
                                        ...
                                        <tr>
                                            <td><input type="checkbox" className="form-check-input m-0 fs-exact-16 d-block" aria-label="..." /></td>
                                            <td><a href="app-order.html" className="text-reset">#1373</a></td>
                                            <td>March 9, 2020</td>
                                            <td><a href="app-customer.html" className="text-reset">Jacob Lee</a></td>
                                            <td>
                                                <div className="d-flex fs-6"><div className="badge badge-sa-success">Yes</div></div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div className="sa-price">
                                                    <span className="sa-price__symbol">$</span>
                                                    <span className="sa-price__integer">27,899</span>
                                                    <span className="sa-price__decimal">.00</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div className="dropdown">
                                                    <button className="btn btn-sa-muted btn-sm" type="button" id="order-context-menu-8" data-bs-toggle="dropdown" aria-expanded="false" aria-label="More">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width={3} height={13} fill="currentColor">
                                                            <path d="M1.5,8C0.7,8,0,7.3,0,6.5S0.7,5,1.5,5S3,5.7,3,6.5S2.3,8,1.5,8z M1.5,3C0.7,3,0,2.3,0,1.5S0.7,0,1.5,0 S3,0.7,3,1.5S2.3,3,1.5,3z M1.5,10C2.3,10,3,10.7,3,11.5S2.3,13,1.5,13S0,12.3,0,11.5S0.7,10,1.5,10z" />
                                                        </svg>
                                                    </button>
                                                    <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="order-context-menu-8">
                                                        <li><a className="dropdown-item" href="#">Edit</a></li>
                                                        <li><a className="dropdown-item" href="#">Duplicate</a></li>
                                                        <li><a className="dropdown-item" href="#">Add tag</a></li>
                                                        <li><a className="dropdown-item" href="#">Remove tag</a></li>
                                        ...
                                        <tr>
                                            <td><input type="checkbox" className="form-check-input m-0 fs-exact-16 d-block" aria-label="..." /></td>
                                            <td><a href="app-order.html" className="text-reset">#1288</a></td>
                                            <td>February 12, 2020</td>
                                            <td><a href="app-customer.html" className="text-reset">Isabel Williams</a></td>
                                            <td>
                                                <div className="d-flex fs-6"><div className="badge badge-sa-success">Yes</div></div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div className="sa-price">
                                                    <span className="sa-price__symbol">$</span>
                                                    <span className="sa-price__integer">4,302</span>
                                                    <span className="sa-price__decimal">.00</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div className="dropdown">
                                                    <button className="btn btn-sa-muted btn-sm" type="button" id="order-context-menu-9" data-bs-toggle="dropdown" aria-expanded="false" aria-label="More">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width={3} height={13} fill="currentColor">
                                                            <path d="M1.5,8C0.7,8,0,7.3,0,6.5S0.7,5,1.5,5S3,5.7,3,6.5S2.3,8,1.5,8z M1.5,3C0.7,3,0,2.3,0,1.5S0.7,0,1.5,0 S3,0.7,3,1.5S2.3,3,1.5,3z M1.5,10C2.3,10,3,10.7,3,11.5S2.3,13,1.5,13S0,12.3,0,11.5S0.7,10,1.5,10z" />
                                                        </svg>
                                                    </button>
                                                    <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="order-context-menu-9">
                                                        <li><a className="dropdown-item" href="#">Edit</a></li>
                                                        <li><a className="dropdown-item" href="#">Duplicate</a></li>
                                                        <li><a className="dropdown-item" href="#">Add tag</a></li>
                                                        <li><a className="dropdown-item" href="#">Remove tag</a></li>
                                        ...
                                        <tr>
                                            <td><input type="checkbox" className="form-check-input m-0 fs-exact-16 d-block" aria-label="..." /></td>
                                            <td><a href="app-order.html" className="text-reset">#1108</a></td>
                                            <td>January 25, 2020</td>
                                            <td><a href="app-customer.html" className="text-reset">Anna Wilson</a></td>
                                            <td>
                                                <div className="d-flex fs-6"><div className="badge badge-sa-success">Yes</div></div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div className="sa-price">
                                                    <span className="sa-price__symbol">$</span>
                                                    <span className="sa-price__integer">239</span>
                                                    <span className="sa-price__decimal">.00</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div className="dropdown">
                                                    <button className="btn btn-sa-muted btn-sm" type="button" id="order-context-menu-10" data-bs-toggle="dropdown" aria-expanded="false" aria-label="More">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width={3} height={13} fill="currentColor">
                                                            <path d="M1.5,8C0.7,8,0,7.3,0,6.5S0.7,5,1.5,5S3,5.7,3,6.5S2.3,8,1.5,8z M1.5,3C0.7,3,0,2.3,0,1.5S0.7,0,1.5,0 S3,0.7,3,1.5S2.3,3,1.5,3z M1.5,10C2.3,10,3,10.7,3,11.5S2.3,13,1.5,13S0,12.3,0,11.5S0.7,10,1.5,10z" />
                                                        </svg>
                                                    </button>
                                                    <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="order-context-menu-10">
                                                        <li><a className="dropdown-item" href="#">Edit</a></li>
                                                        <li><a className="dropdown-item" href="#">Duplicate</a></li>
                                                        <li><a className="dropdown-item" href="#">Add tag</a></li>
                                                        <li><a className="dropdown-item" href="#">Remove tag</a></li>
                                        ...
                                        <tr>
                                            <td><input type="checkbox" className="form-check-input m-0 fs-exact-16 d-block" aria-label="..." /></td>
                                            <td><a href="app-order.html" className="text-reset">#1002</a></td>
                                            <td>January 3, 2020</td>
                                            <td><a href="app-customer.html" className="text-reset">Adam Taylor</a></td>
                                            <td>
                                                <div className="d-flex fs-6"><div className="badge badge-sa-secondary">No</div></div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div className="sa-price">
                                                    <span className="sa-price__symbol">$</span>
                                                    <span className="sa-price__integer">5,103</span>
                                                    <span className="sa-price__decimal">.00</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div className="dropdown">
                                                    <button className="btn btn-sa-muted btn-sm" type="button" id="order-context-menu-11" data-bs-toggle="dropdown" aria-expanded="false" aria-label="More">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width={3} height={13} fill="currentColor">
                                                            <path d="M1.5,8C0.7,8,0,7.3,0,6.5S0.7,5,1.5,5S3,5.7,3,6.5S2.3,8,1.5,8z M1.5,3C0.7,3,0,2.3,0,1.5S0.7,0,1.5,0 S3,0.7,3,1.5S2.3,3,1.5,3z M1.5,10C2.3,10,3,10.7,3,11.5S2.3,13,1.5,13S0,12.3,0,11.5S0.7,10,1.5,10z" />
                                                        </svg>
                                                    </button>
                                                    <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="order-context-menu-11">
                                                        <li><a className="dropdown-item" href="#">Edit</a></li>
                                                        <li><a className="dropdown-item" href="#">Duplicate</a></li>
                                                        <li><a className="dropdown-item" href="#">Add tag</a></li>
                                                        <li><a className="dropdown-item" href="#">Remove tag</a></li>
