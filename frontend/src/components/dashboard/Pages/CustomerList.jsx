                        ...
                        <ul className="sa-nav sa-nav--sidebar" data-sa-collapse>
                            <li className="sa-nav__section">
                                ...
                                <ul className="sa-nav__menu sa-nav__menu--root">
                                    ...
                                    <li className="sa-nav__menu-item sa-nav__menu-item--has-icon" data-sa-collapse-item="sa-nav__menu-item--open">
                                        ...
                                        <ul className="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content>
                                            <li className="sa-nav__menu-item">
                                                <a href="app-customers-list.html" className="sa-nav__link">
                                                    <span className="sa-nav__menu-item-padding" />
                                                    <span className="sa-nav__title">Customers List</span>
                                                </a>
                                            </li>
                                            <li className="sa-nav__menu-item">
                                                <a href="app-customer.html" className="sa-nav__link">
                                                    <span className="sa-nav__menu-item-padding" />
                                    ...
                                    <li className="sa-nav__menu-item sa-nav__menu-item--has-icon" data-sa-collapse-item="sa-nav__menu-item--open">
                                        ...
                                        <ul className="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content>
                                            <li className="sa-nav__menu-item">
                                                <a href="app-orders-list.html" className="sa-nav__link">
                                                    <span className="sa-nav__menu-item-padding" />
                                                    <span className="sa-nav__title">Orders List</span>
                                                </a>
                                            </li>
                                            <li className="sa-nav__menu-item">
                                                <a href="app-order.html" className="sa-nav__link">
                                                    <span className="sa-nav__menu-item-padding" />
                                                    <span className="sa-nav__title">Order Details</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
                                    ...
                                    <li className="sa-nav__menu-item sa-nav__menu-item--has-icon" data-sa-collapse-item="sa-nav__menu-item--open">
                                        <a href className="sa-nav__link" data-sa-collapse-trigger>
                                            <span className="sa-nav__icon"><i className="fas fa-envelope" /></span>
                                    ...
                                    <li className="sa-nav__menu-item sa-nav__menu-item--has-icon">
                                        <a href="app-chat.html" className="sa-nav__link">
                                            <span className="sa-nav__icon"><i className="fas fa-comment" /></span>
                                    ...
                                    <li className="sa-nav__menu-item sa-nav__menu-item--has-icon">
                                        <a href="app-file-manager.html" className="sa-nav__link">
                                            <span className="sa-nav__icon"><i className="fas fa-hdd" /></span>
                                            <span className="sa-nav__title">File Manager</span>
                                        </a>
                                    </li>
                                    <li className="sa-nav__menu-item sa-nav__menu-item--has-icon">
                                        <a href="app-calendar.html" className="sa-nav__link">
                                            <span className="sa-nav__icon"><i className="fas fa-calendar-alt" /></span>
                            ...
                            <li className="sa-nav__section">
                                ...
                                <ul className="sa-nav__menu sa-nav__menu--root">
                                    <li className="sa-nav__menu-item sa-nav__menu-item--has-icon" data-sa-collapse-item="sa-nav__menu-item--open">
                                        <a href className="sa-nav__link" data-sa-collapse-trigger>
                                            <span className="sa-nav__icon"><i className="fas fa-lock" /></span>
                                            <span className="sa-nav__title">Authentication</span>
                                            <span className="sa-nav__arrow">
                                                <svg xmlns="http://www.w3.org/2000/svg" width={6} height={9} viewBox="0 0 6 9" fill="currentColor">
                                                    <path d="M5.605,0.213 C6.007,0.613 6.107,1.212 5.706,1.612 L2.696,4.511 L5.706,7.409 C6.107,7.809 6.107,8.509 5.605,8.808 C5.204,9.108 4.702,9.108 4.301,8.709 L-0.013,4.511 L4.401,0.313 C4.702,-0.087 5.304,-0.087 5.605,0.213 Z" />
                                                </svg>
                                        ...
                                        <ul className="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content>
                                            <li className="sa-nav__menu-item">
                                                <a href="auth-sign-in.html" className="sa-nav__link">
                                                    <span className="sa-nav__menu-item-padding" />
                                                    <span className="sa-nav__title">Sign In</span>
                                                </a>
                                            </li>
                                            <li className="sa-nav__menu-item">
                                                <a href="auth-sign-up.html" className="sa-nav__link">
                                                    <span className="sa-nav__menu-item-padding" />
                                                    <span className="sa-nav__title">Sign Up</span>
                                                </a>
                                            </li>
                                            <li className="sa-nav__menu-item">
                                                <a href="auth-forgot-password.html" className="sa-nav__link">
                                                    <span className="sa-nav__menu-item-padding" />
                                                    <span className="sa-nav__title">Forgot Password</span>
                                                </a>
                                            </li>
                                            <li className="sa-nav__menu-item">
                                                <a href="auth-reset-password.html" className="sa-nav__link">
                                                    <span className="sa-nav__menu-item-padding" />
                                                    <span className="sa-nav__title">Reset Password</span>
                                                </a>
                                            </li>
                                            <li className="sa-nav__menu-item">
                                                <a href="auth-email-confirmation.html" className="sa-nav__link">
                                                    <span className="sa-nav__menu-item-padding" />
                                                    <span className="sa-nav__title">Verify Account</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li className="sa-nav__menu-item sa-nav__menu-item--has-icon">
                                        <a href="page-invoice.html" className="sa-nav__link">
                                            <span className="sa-nav__icon"><i className="fas fa-file-alt" /></span>
                                            <span className="sa-nav__title">Invoice</span>
                                        </a>
                                    </li>
                                    <li className="sa-nav__menu-item sa-nav__menu-item--has-icon">
                                        <a href="page-pricing-table.html" className="sa-nav__link">
                                            <span className="sa-nav__icon"><i className="fas fa-dollar-sign" /></span>
                                            <span className="sa-nav__title">Pricing Table</span>
                                        </a>
                                    </li>
                                    <li className="sa-nav__menu-item sa-nav__menu-item--has-icon">
                                        <a href="page-faq.html" className="sa-nav__link">
                                            <span className="sa-nav__icon"><i className="fas fa-info-circle" /></span>
                                            <span className="sa-nav__title">FAQ</span>
                                        </a>
                                    </li>
                                    <li className="sa-nav__menu-item sa-nav__menu-item--has-icon">
                                        <a href="page-terms.html" className="sa-nav__link">
                                            <span className="sa-nav__icon"><i className="fas fa-check-square" /></span>
                                            <span className="sa-nav__title">Terms And Conditions</span>
                                        </a>
                                    </li>
                                    <li className="sa-nav__menu-item sa-nav__menu-item--has-icon">
                                        <a href="page-help-center.html" className="sa-nav__link">
                                            <span className="sa-nav__icon"><i className="fas fa-question-circle" /></span>
                                            <span className="sa-nav__title">Help Center</span>
                                        </a>
                                    </li>
                                    <li className="sa-nav__menu-item sa-nav__menu-item--has-icon">
                                        <a href="page-404.html" className="sa-nav__link">
                                            <span className="sa-nav__icon"><i className="fas fa-bomb" /></span>
                                            <span className="sa-nav__title">Not Found</span>
                                        </a>
                                    </li>
                                    <li className="sa-nav__menu-item sa-nav__menu-item--has-icon" data-sa-collapse-item="sa-nav__menu-item--open">
                                        <a href className="sa-nav__link" data-sa-collapse-trigger>
                                            <span className="sa-nav__icon"><i className="fas fa-bars" /></span>
                                            <span className="sa-nav__title">Menu Level 0</span>
                                            <span className="sa-nav__arrow">
                                                <svg xmlns="http://www.w3.org/2000/svg" width={6} height={9} viewBox="0 0 6 9" fill="currentColor">
                                                    <path d="M5.605,0.213 C6.007,0.613 6.107,1.212 5.706,1.612 L2.696,4.511 L5.706,7.409 C6.107,7.809 6.107,8.509 5.605,8.808 C5.204,9.108 4.702,9.108 4.301,8.709 L-0.013,4.511 L4.401,0.313 C4.702,-0.087 5.304,-0.087 5.605,0.213 Z" />
                                                </svg>
                                        ...
                                        <ul className="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content>
                                            <li className="sa-nav__menu-item" data-sa-collapse-item="sa-nav__menu-item--open">
                                                <a href className="sa-nav__link" data-sa-collapse-trigger>
                                                    <span className="sa-nav__menu-item-padding" />
                                                    <span className="sa-nav__title">Menu Level 1</span>
                                                    <span className="sa-nav__arrow">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width={6} height={9} viewBox="0 0 6 9" fill="currentColor">
                                                            <path d="M5.605,0.213 C6.007,0.613 6.107,1.212 5.706,1.612 L2.696,4.511 L5.706,7.409 C6.107,7.809 6.107,8.509 5.605,8.808 C5.204,9.108 4.702,9.108 4.301,8.709 L-0.013,4.511 L4.401,0.313 C4.702,-0.087 5.304,-0.087 5.605,0.213 Z" />
                                                        </svg>
                                                ...
                                                <ul className="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content>
                                                    <li className="sa-nav__menu-item" data-sa-collapse-item="sa-nav__menu-item--open">
                                                        <a href className="sa-nav__link" data-sa-collapse-trigger>
                                                            <span className="sa-nav__menu-item-padding" />
                                                            <span className="sa-nav__menu-item-padding" />
                                                            <span className="sa-nav__title">Menu Level 2</span>
                                                            <span className="sa-nav__arrow">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width={6} height={9} viewBox="0 0 6 9" fill="currentColor">
                                                                    <path d="M5.605,0.213 C6.007,0.613 6.107,1.212 5.706,1.612 L2.696,4.511 L5.706,7.409 C6.107,7.809 6.107,8.509 5.605,8.808 C5.204,9.108 4.702,9.108 4.301,8.709 L-0.013,4.511 L4.401,0.313 C4.702,-0.087 5.304,-0.087 5.605,0.213 Z" />
                                                                </svg>
                                                        ...
                                                        <ul className="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content>
                                                            <li className="sa-nav__menu-item">
                                                                <a href className="sa-nav__link">
                                                                    ...
                                                                    <span className="sa-nav__menu-item-padding" />
                                                                    <span className="sa-nav__menu-item-padding" />
                                                                    <span className="sa-nav__title">Menu Level 3</span>
                                                                </a>
                                                            </li>
                                                        </ul>
                                                    </li>
                            ...
                            <li className="sa-nav__section">
                                ...
                                <ul className="sa-nav__menu sa-nav__menu--root">
                                    <li className="sa-nav__menu-item sa-nav__menu-item--has-icon" data-sa-collapse-item="sa-nav__menu-item--open">
                                        <a href className="sa-nav__link" data-sa-collapse-trigger>
                                            <span className="sa-nav__icon"><i className="fas fa-compass" /></span>
                                            <span className="sa-nav__title">Components</span>
                                            <span className="sa-nav__arrow">
                                                <svg xmlns="http://www.w3.org/2000/svg" width={6} height={9} viewBox="0 0 6 9" fill="currentColor">
                                                    <path d="M5.605,0.213 C6.007,0.613 6.107,1.212 5.706,1.612 L2.696,4.511 L5.706,7.409 C6.107,7.809 6.107,8.509 5.605,8.808 C5.204,9.108 4.702,9.108 4.301,8.709 L-0.013,4.511 L4.401,0.313 C4.702,-0.087 5.304,-0.087 5.605,0.213 Z" />
                                                </svg>
                                        ...
                                        <ul className="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content>
                                            <li className="sa-nav__menu-item">
                                                <a href="components-accordion.html" className="sa-nav__link">
                                                    <span className="sa-nav__menu-item-padding" />
                                                    <span className="sa-nav__title">Accordion</span>
                                                </a>
                                            </li>
                                            <li className="sa-nav__menu-item">
                                                <a href="components-alerts.html" className="sa-nav__link">
                                                    <span className="sa-nav__menu-item-padding" />
                                                    <span className="sa-nav__title">Alerts</span>
                                                </a>
                                            </li>
                                            <li className="sa-nav__menu-item">
                                                <a href="components-badge.html" className="sa-nav__link">
                                                    <span className="sa-nav__menu-item-padding" />
                                                    <span className="sa-nav__title">Badge</span>
                                                </a>
                                            </li>
                                            <li className="sa-nav__menu-item">
                                                <a href="components-breadcrumb.html" className="sa-nav__link">
                                                    <span className="sa-nav__menu-item-padding" />
                                                    <span className="sa-nav__title">Breadcrumb</span>
                                                </a>
                                            </li>
                                            <li className="sa-nav__menu-item">
                                                <a href="components-buttons.html" className="sa-nav__link">
                                                    <span className="sa-nav__menu-item-padding" />
                                                    <span className="sa-nav__title">Buttons</span>
                                                </a>
                                            </li>
                                            <li className="sa-nav__menu-item">
                                                <a href="components-button-group.html" className="sa-nav__link">
                                                    <span className="sa-nav__menu-item-padding" />
                                                    <span className="sa-nav__title">Button group</span>
                                                </a>
                                            </li>
                                            <li className="sa-nav__menu-item">
                                                <a href="components-cards.html" className="sa-nav__link">
                                                    <span className="sa-nav__menu-item-padding" />
                                                    <span className="sa-nav__title">Cards</span>
                                                </a>
                                            </li>
                                            <li className="sa-nav__menu-item">
                                                <a href="components-carousel.html" className="sa-nav__link">
                                                    <span className="sa-nav__menu-item-padding" />
                                                    <span className="sa-nav__title">Carousel</span>
                                                </a>
                                            </li>
                                            <li className="sa-nav__menu-item">
                                                <a href="components-collapse.html" className="sa-nav__link">
                                                    <span className="sa-nav__menu-item-padding" />
                                                    <span className="sa-nav__title">Collapse</span>
                                                </a>
                                            </li>
                                            <li className="sa-nav__menu-item">
                                                <a href="components-dropdowns.html" className="sa-nav__link">
                                                    <span className="sa-nav__menu-item-padding" />
                                                    <span className="sa-nav__title">Dropdowns</span>
                                                </a>
                                            </li>
                                            <li className="sa-nav__menu-item">
                                                <a href="components-list-group.html" className="sa-nav__link">
                                                    <span className="sa-nav__menu-item-padding" />
                                                    <span className="sa-nav__title">List group</span>
                                                </a>
                                            </li>
                                            <li className="sa-nav__menu-item">
                                                <a href="components-modal.html" className="sa-nav__link">
                                                    <span className="sa-nav__menu-item-padding" />
                                                    <span className="sa-nav__title">Modal</span>
                                                </a>
                                            </li>
                                            <li className="sa-nav__menu-item">
                                                <a href="components-navs.html" className="sa-nav__link">
                                                    <span className="sa-nav__menu-item-padding" />
                                                    <span className="sa-nav__title">Navs</span>
                                                </a>
                                            </li>
                                            <li className="sa-nav__menu-item">
                                                <a href="components-nouislider.html" className="sa-nav__link">
                                                    <span className="sa-nav__menu-item-padding" />
                                                    <span className="sa-nav__title">NoUiSlider</span>
                                                </a>
                                            </li>
                                            <li className="sa-nav__menu-item">
                                                <a href="components-offcanvas.html" className="sa-nav__link">
                                                    <span className="sa-nav__menu-item-padding" />
                                                    <span className="sa-nav__title">Offcanvas</span>
                                                </a>
                                            </li>
                                            <li className="sa-nav__menu-item">
                                                <a href="components-pagination.html" className="sa-nav__link">
                                                    <span className="sa-nav__menu-item-padding" />
                                                    <span className="sa-nav__title">Pagination</span>
                                                </a>
                                            </li>
                                            <li className="sa-nav__menu-item">
                                                <a href="components-placeholders.html" className="sa-nav__link">
                                                    <span className="sa-nav__menu-item-padding" />
                                                    <span className="sa-nav__title">Placeholders</span>
                                                </a>
                                            </li>
                                            <li className="sa-nav__menu-item">
                                                <a href="components-popovers.html" className="sa-nav__link">
                                                    <span className="sa-nav__menu-item-padding" />
                                                    <span className="sa-nav__title">Popovers</span>
                                                </a>
                                            </li>
                                            <li className="sa-nav__menu-item">
                                                <a href="components-progress.html" className="sa-nav__link">
                                                    <span className="sa-nav__menu-item-padding" />
                                                    <span className="sa-nav__title">Progress</span>
                                                </a>
                                            </li>
                                            <li className="sa-nav__menu-item">
                                                <a href="components-scrollspy.html" className="sa-nav__link">
                                                    <span className="sa-nav__menu-item-padding" />
                                                    <span className="sa-nav__title">Scrollspy</span>
                                                </a>
                                            </li>
                                            <li className="sa-nav__menu-item">
                                                <a href="components-spinners.html" className="sa-nav__link">
                                                    <span className="sa-nav__menu-item-padding" />
                                                    <span className="sa-nav__title">Spinners</span>
                                                </a>
                                            </li>
                                            <li className="sa-nav__menu-item">
                                                <a href="components-symbols.html" className="sa-nav__link">
                                                    <span className="sa-nav__menu-item-padding" />
                                                    <span className="sa-nav__title">Symbols</span>
                                                </a>
                                            </li>
                                            <li className="sa-nav__menu-item">
                                                <a href="components-tabs.html" className="sa-nav__link">
                                                    <span className="sa-nav__menu-item-padding" />
                                                    <span className="sa-nav__title">Tabs</span>
                                                </a>
                                            </li>
                                            <li className="sa-nav__menu-item">
                                                <a href="components-toasts.html" className="sa-nav__link">
                                                    <span className="sa-nav__menu-item-padding" />
                                                    <span className="sa-nav__title">Toasts</span>
                                                </a>
                                            </li>
                                            <li className="sa-nav__menu-item">
                                                <a href="components-tooltips.html" className="sa-nav__link">
                                                    <span className="sa-nav__menu-item-padding" />
                                                    <span className="sa-nav__title">Tooltips</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li className="sa-nav__menu-item sa-nav__menu-item--has-icon" data-sa-collapse-item="sa-nav__menu-item--open">
                                        <a href className="sa-nav__link" data-sa-collapse-trigger>
                                            <span className="sa-nav__icon"><i className="fas fa-toggle-on" /></span>
                                            <span className="sa-nav__title">Forms</span>
                                            <span className="sa-nav__arrow">
                                                <svg xmlns="http://www.w3.org/2000/svg" width={6} height={9} viewBox="0 0 6 9" fill="currentColor">
                                                    <path d="M5.605,0.213 C6.007,0.613 6.107,1.212 5.706,1.612 L2.696,4.511 L5.706,7.409 C6.107,7.809 6.107,8.509 5.605,8.808 C5.204,9.108 4.702,9.108 4.301,8.709 L-0.013,4.511 L4.401,0.313 C4.702,-0.087 5.304,-0.087 5.605,0.213 Z" />
                                                </svg>
                                        ...
                                        <ul className="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content>
                                            <li className="sa-nav__menu-item">
                                                <a href="forms-text-box.html" className="sa-nav__link">
                                                    <span className="sa-nav__menu-item-padding" />
                                                    <span className="sa-nav__title">Text Box</span>
                                                </a>
                                            </li>
                                            <li className="sa-nav__menu-item">
                                                <a href="forms-text-area.html" className="sa-nav__link">
                                                    <span className="sa-nav__menu-item-padding" />
                                                    <span className="sa-nav__title">Text Area</span>
                                                </a>
                                            </li>
                                            <li className="sa-nav__menu-item">
                                                <a href="forms-select.html" className="sa-nav__link">
                                                    <span className="sa-nav__menu-item-padding" />
                                                    <span className="sa-nav__title">Select</span>
                                                </a>
                                            </li>
                                            <li className="sa-nav__menu-item">
                                                <a href="forms-checks-and-radios.html" className="sa-nav__link">
                                                    <span className="sa-nav__menu-item-padding" />
                                                    <span className="sa-nav__title">Checks And Radios</span>
                                                </a>
                                            </li>
                                            <li className="sa-nav__menu-item">
                                                <a href="forms-file.html" className="sa-nav__link">
                                                    <span className="sa-nav__menu-item-padding" />
                                                    <span className="sa-nav__title">File</span>
                                                </a>
                                            </li>
                                            <li className="sa-nav__menu-item">
                                                <a href="forms-range.html" className="sa-nav__link">
                                                    <span className="sa-nav__menu-item-padding" />
                                                    <span className="sa-nav__title">Range</span>
                                                </a>
                                            </li>
                                            <li className="sa-nav__menu-item">
                                                <a href="forms-input-group.html" className="sa-nav__link">
                                                    <span className="sa-nav__menu-item-padding" />
                                                    <span className="sa-nav__title">Input Group</span>
                                                </a>
                                            </li>
                                            <li className="sa-nav__menu-item">
                                                <a href="forms-layout.html" className="sa-nav__link">
                                                    <span className="sa-nav__menu-item-padding" />
                                                    <span className="sa-nav__title">Layout</span>
                                                </a>
                                            </li>
                                            <li className="sa-nav__menu-item">
                                                <a href="forms-help-text.html" className="sa-nav__link">
                                                    <span className="sa-nav__menu-item-padding" />
                                                    <span className="sa-nav__title">Help Text</span>
                                                </a>
                                            </li>
                                            <li className="sa-nav__menu-item">
                                                <a href="forms-validation.html" className="sa-nav__link">
                                                    <span className="sa-nav__menu-item-padding" />
                                                    <span className="sa-nav__title">Validation</span>
                                                </a>
                                            </li>
                                            <li className="sa-nav__menu-item">
                                                <a href="forms-quill.html" className="sa-nav__link">
                                                    <span className="sa-nav__menu-item-padding" />
                                                    <span className="sa-nav__title">Quill</span>
                                                </a>
                                            </li>
                                            <li className="sa-nav__menu-item">
                                                <a href="forms-air-datepicker.html" className="sa-nav__link">
                                                    <span className="sa-nav__menu-item-padding" />
                                                    <span className="sa-nav__title">Air Datepicker</span>
                                                </a>
                                            </li>
                                            <li className="sa-nav__menu-item">
                                                <a href="forms-select2.html" className="sa-nav__link">
                                                    <span className="sa-nav__menu-item-padding" />
                                                    <span className="sa-nav__title">Select2</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li className="sa-nav__menu-item sa-nav__menu-item--has-icon" data-sa-collapse-item="sa-nav__menu-item--open">
                                        <a href className="sa-nav__link" data-sa-collapse-trigger>
                                            <span className="sa-nav__icon"><i className="fas fa-table" /></span>
                                            <span className="sa-nav__title">Tables</span>
                                            <span className="sa-nav__arrow">
                                                <svg xmlns="http://www.w3.org/2000/svg" width={6} height={9} viewBox="0 0 6 9" fill="currentColor">
                                                    <path d="M5.605,0.213 C6.007,0.613 6.107,1.212 5.706,1.612 L2.696,4.511 L5.706,7.409 C6.107,7.809 6.107,8.509 5.605,8.808 C5.204,9.108 4.702,9.108 4.301,8.709 L-0.013,4.511 L4.401,0.313 C4.702,-0.087 5.304,-0.087 5.605,0.213 Z" />
                                                </svg>
                                        ...
                                        <ul className="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content>
                                            <li className="sa-nav__menu-item">
                                                <a href="tables-basic-tables.html" className="sa-nav__link">
                                                    <span className="sa-nav__menu-item-padding" />
                                                    <span className="sa-nav__title">Basic Tables</span>
                                                </a>
                                            </li>
                                            <li className="sa-nav__menu-item">
                                                <a href="tables-datatables.html" className="sa-nav__link">
                                                    <span className="sa-nav__menu-item-padding" />
                                                    <span className="sa-nav__title">DataTables</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li className="sa-nav__menu-item sa-nav__menu-item--has-icon">
                                        <a href="icons.html" className="sa-nav__link">
                                            <span className="sa-nav__icon"><i className="fas fa-tree" /></span>
                                            <span className="sa-nav__title">Icons</span>
                                        </a>
                                    </li>
                                    <li className="sa-nav__menu-item sa-nav__menu-item--has-icon">
                                        <a href="charts.html" className="sa-nav__link">
                                            <span className="sa-nav__icon"><i className="fas fa-chart-pie" /></span>
                        ...
                        <div className="container">
                            <div className="py-5">
                                <div className="row g-4 align-items-center">
                                    ...
                                    <div className="col-auto d-flex"><a href="app-customer.html" className="btn btn-primary">New customer</a></div>
                                </div>
                            </div>
                            <div className="card">
                                <div className="p-4">
                                    <input type="text" placeholder="Start typing to search for customers" className="form-control form-control--search mx-auto" id="table-search" />
                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    <a href="app-customer.html" className="me-4">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="text-muted mt-n1">moore-jessica@example.com</div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td className="text-nowrap">June 26, 2021</td>
                                            <td>USA</td>
                                            <td>Default</td>
                                            <td>
                                                <div className="sa-price">
                                                    <span className="sa-price__symbol">$</span>
                                                    <span className="sa-price__integer">28,522</span>
                                                    <span className="sa-price__decimal">.35</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div className="dropdown">
                                                    <button className="btn btn-sa-muted btn-sm" type="button" id="customer-context-menu-0" data-bs-toggle="dropdown" aria-expanded="false" aria-label="More">
                                                    ...
                                                    <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="customer-context-menu-0">
                                            ...
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="text-muted mt-n1">taylor-adam@example.com</div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td className="text-nowrap">May 15, 2021</td>
                                            <td>Russia</td>
                                            <td>Default</td>
                                            <td>
                                                <div className="sa-price">
                                                    <span className="sa-price__symbol">$</span>
                                                    <span className="sa-price__integer">34,392</span>
                                                    <span className="sa-price__decimal">.10</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div className="dropdown">
                                                    <button className="btn btn-sa-muted btn-sm" type="button" id="customer-context-menu-1" data-bs-toggle="dropdown" aria-expanded="false" aria-label="More">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width={3} height={13} fill="currentColor">
                                                            <path d="M1.5,8C0.7,8,0,7.3,0,6.5S0.7,5,1.5,5S3,5.7,3,6.5S2.3,8,1.5,8z M1.5,3C0.7,3,0,2.3,0,1.5S0.7,0,1.5,0 S3,0.7,3,1.5S2.3,3,1.5,3z M1.5,10C2.3,10,3,10.7,3,11.5S2.3,13,1.5,13S0,12.3,0,11.5S0.7,10,1.5,10z" />
                                                        </svg>
                                                    </button>
                                                    <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="customer-context-menu-1">
                                                        <li><a className="dropdown-item" href="#">Edit</a></li>
                                                        <li><a className="dropdown-item" href="#">Duplicate</a></li>
                                                        <li><a className="dropdown-item" href="#">Add tag</a></li>
                                                        <li><a className="dropdown-item" href="#">Remove tag</a></li>
                                            ...
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="text-muted mt-n1">garcia-helena@example.com</div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td className="text-nowrap">February 23, 2021</td>
                                            <td>China</td>
                                            <td>Default</td>
                                            <td>
                                                <div className="sa-price">
                                                    <span className="sa-price__symbol">$</span>
                                                    <span className="sa-price__integer">5,702</span>
                                                    <span className="sa-price__decimal">.02</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div className="dropdown">
                                                    <button className="btn btn-sa-muted btn-sm" type="button" id="customer-context-menu-2" data-bs-toggle="dropdown" aria-expanded="false" aria-label="More">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width={3} height={13} fill="currentColor">
                                                            <path d="M1.5,8C0.7,8,0,7.3,0,6.5S0.7,5,1.5,5S3,5.7,3,6.5S2.3,8,1.5,8z M1.5,3C0.7,3,0,2.3,0,1.5S0.7,0,1.5,0 S3,0.7,3,1.5S2.3,3,1.5,3z M1.5,10C2.3,10,3,10.7,3,11.5S2.3,13,1.5,13S0,12.3,0,11.5S0.7,10,1.5,10z" />
                                                        </svg>
                                                    </button>
                                                    <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="customer-context-menu-2">
                                                        <li><a className="dropdown-item" href="#">Edit</a></li>
                                                        <li><a className="dropdown-item" href="#">Duplicate</a></li>
                                                        <li><a className="dropdown-item" href="#">Add tag</a></li>
                                                        <li><a className="dropdown-item" href="#">Remove tag</a></li>
                                            ...
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="text-muted mt-n1">ford-ryan@example.com</div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td className="text-nowrap">Oct 19, 2021</td>
                                            <td>India</td>
                                            <td>Default</td>
                                            <td>
                                                <div className="sa-price">
                                                    <span className="sa-price__symbol">$</span>
                                                    <span className="sa-price__integer">973</span>
                                                    <span className="sa-price__decimal">.64</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div className="dropdown">
                                                    <button className="btn btn-sa-muted btn-sm" type="button" id="customer-context-menu-3" data-bs-toggle="dropdown" aria-expanded="false" aria-label="More">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width={3} height={13} fill="currentColor">
                                                            <path d="M1.5,8C0.7,8,0,7.3,0,6.5S0.7,5,1.5,5S3,5.7,3,6.5S2.3,8,1.5,8z M1.5,3C0.7,3,0,2.3,0,1.5S0.7,0,1.5,0 S3,0.7,3,1.5S2.3,3,1.5,3z M1.5,10C2.3,10,3,10.7,3,11.5S2.3,13,1.5,13S0,12.3,0,11.5S0.7,10,1.5,10z" />
                                                        </svg>
                                                    </button>
                                                    <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="customer-context-menu-3">
                                                        <li><a className="dropdown-item" href="#">Edit</a></li>
                                                        <li><a className="dropdown-item" href="#">Duplicate</a></li>
                                                        <li><a className="dropdown-item" href="#">Add tag</a></li>
                                                        <li><a className="dropdown-item" href="#">Remove tag</a></li>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <a href="app-customer.html" className="text-reset">Olivia Smith</a>
                                                        <div className="text-muted mt-n1">smith-olivia@example.com</div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td className="text-nowrap">November 9, 2021</td>
                                            <td>USA</td>
                                            <td>Default</td>
                                            <td>
                                                <div className="sa-price">
                                                    <span className="sa-price__symbol">$</span>
                                                    <span className="sa-price__integer">8,061</span>
                                                    <span className="sa-price__decimal">.02</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div className="dropdown">
                                                    <button className="btn btn-sa-muted btn-sm" type="button" id="customer-context-menu-4" data-bs-toggle="dropdown" aria-expanded="false" aria-label="More">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width={3} height={13} fill="currentColor">
                                                            <path d="M1.5,8C0.7,8,0,7.3,0,6.5S0.7,5,1.5,5S3,5.7,3,6.5S2.3,8,1.5,8z M1.5,3C0.7,3,0,2.3,0,1.5S0.7,0,1.5,0 S3,0.7,3,1.5S2.3,3,1.5,3z M1.5,10C2.3,10,3,10.7,3,11.5S2.3,13,1.5,13S0,12.3,0,11.5S0.7,10,1.5,10z" />
                                                        </svg>
                                                    </button>
                                                    <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="customer-context-menu-4">
                                                        <li><a className="dropdown-item" href="#">Edit</a></li>
                                                        <li><a className="dropdown-item" href="#">Duplicate</a></li>
                                                        <li><a className="dropdown-item" href="#">Add tag</a></li>
                                                        <li><a className="dropdown-item" href="#">Remove tag</a></li>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <a href="app-customer.html" className="text-reset">Kevin Smith</a>
                                                        <div className="text-muted mt-n1">smith-kevin@example.com</div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td className="text-nowrap">April 4, 2021</td>
                                            <td>Poland</td>
                                            <td>Default</td>
                                            <td>
                                                <div className="sa-price">
                                                    <span className="sa-price__symbol">$</span>
                                                    <span className="sa-price__integer">6,147</span>
                                                    <span className="sa-price__decimal">.64</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div className="dropdown">
                                                    <button className="btn btn-sa-muted btn-sm" type="button" id="customer-context-menu-5" data-bs-toggle="dropdown" aria-expanded="false" aria-label="More">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width={3} height={13} fill="currentColor">
                                                            <path d="M1.5,8C0.7,8,0,7.3,0,6.5S0.7,5,1.5,5S3,5.7,3,6.5S2.3,8,1.5,8z M1.5,3C0.7,3,0,2.3,0,1.5S0.7,0,1.5,0 S3,0.7,3,1.5S2.3,3,1.5,3z M1.5,10C2.3,10,3,10.7,3,11.5S2.3,13,1.5,13S0,12.3,0,11.5S0.7,10,1.5,10z" />
                                                        </svg>
                                                    </button>
                                                    <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="customer-context-menu-5">
                                                        <li><a className="dropdown-item" href="#">Edit</a></li>
                                                        <li><a className="dropdown-item" href="#">Duplicate</a></li>
                                                        <li><a className="dropdown-item" href="#">Add tag</a></li>
                                                        <li><a className="dropdown-item" href="#">Remove tag</a></li>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <a href="app-customer.html" className="text-reset">Brian Wood</a>
                                                        <div className="text-muted mt-n1">wood-brian@example.com</div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td className="text-nowrap">August 17, 2021</td>
                                            <td>Germany</td>
                                            <td>Default</td>
                                            <td>
                                                <div className="sa-price">
                                                    <span className="sa-price__symbol">$</span>
                                                    <span className="sa-price__integer">1,332</span>
                                                    <span className="sa-price__decimal">.58</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div className="dropdown">
                                                    <button className="btn btn-sa-muted btn-sm" type="button" id="customer-context-menu-6" data-bs-toggle="dropdown" aria-expanded="false" aria-label="More">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width={3} height={13} fill="currentColor">
                                                            <path d="M1.5,8C0.7,8,0,7.3,0,6.5S0.7,5,1.5,5S3,5.7,3,6.5S2.3,8,1.5,8z M1.5,3C0.7,3,0,2.3,0,1.5S0.7,0,1.5,0 S3,0.7,3,1.5S2.3,3,1.5,3z M1.5,10C2.3,10,3,10.7,3,11.5S2.3,13,1.5,13S0,12.3,0,11.5S0.7,10,1.5,10z" />
                                                        </svg>
                                                    </button>
                                                    <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="customer-context-menu-6">
                                                        <li><a className="dropdown-item" href="#">Edit</a></li>
                                                        <li><a className="dropdown-item" href="#">Duplicate</a></li>
                                                        <li><a className="dropdown-item" href="#">Add tag</a></li>
                                                        <li><a className="dropdown-item" href="#">Remove tag</a></li>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <a href="app-customer.html" className="text-reset">Ethan Young</a>
                                                        <div className="text-muted mt-n1">young-ethan@example.com</div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td className="text-nowrap">September 28, 2021</td>
                                            <td>Russia</td>
                                            <td>Wholesaler</td>
                                            <td>
                                                <div className="sa-price">
                                                    <span className="sa-price__symbol">$</span>
                                                    <span className="sa-price__integer">594</span>
                                                    <span className="sa-price__decimal">.97</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div className="dropdown">
                                                    <button className="btn btn-sa-muted btn-sm" type="button" id="customer-context-menu-7" data-bs-toggle="dropdown" aria-expanded="false" aria-label="More">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width={3} height={13} fill="currentColor">
                                                            <path d="M1.5,8C0.7,8,0,7.3,0,6.5S0.7,5,1.5,5S3,5.7,3,6.5S2.3,8,1.5,8z M1.5,3C0.7,3,0,2.3,0,1.5S0.7,0,1.5,0 S3,0.7,3,1.5S2.3,3,1.5,3z M1.5,10C2.3,10,3,10.7,3,11.5S2.3,13,1.5,13S0,12.3,0,11.5S0.7,10,1.5,10z" />
                                                        </svg>
                                                    </button>
                                                    <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="customer-context-menu-7">
                                                        <li><a className="dropdown-item" href="#">Edit</a></li>
                                                        <li><a className="dropdown-item" href="#">Duplicate</a></li>
                                                        <li><a className="dropdown-item" href="#">Add tag</a></li>
                                                        <li><a className="dropdown-item" href="#">Remove tag</a></li>
                                            ...
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="text-muted mt-n1">jones-charlotte@example.com</div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td className="text-nowrap">December 31, 2021</td>
                                            <td>Canada</td>
                                            <td>Default</td>
                                            <td>
                                                <div className="sa-price">
                                                    <span className="sa-price__symbol">$</span>
                                                    <span className="sa-price__integer">5,192</span>
                                                    <span className="sa-price__decimal">.42</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div className="dropdown">
                                                    <button className="btn btn-sa-muted btn-sm" type="button" id="customer-context-menu-8" data-bs-toggle="dropdown" aria-expanded="false" aria-label="More">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width={3} height={13} fill="currentColor">
                                                            <path d="M1.5,8C0.7,8,0,7.3,0,6.5S0.7,5,1.5,5S3,5.7,3,6.5S2.3,8,1.5,8z M1.5,3C0.7,3,0,2.3,0,1.5S0.7,0,1.5,0 S3,0.7,3,1.5S2.3,3,1.5,3z M1.5,10C2.3,10,3,10.7,3,11.5S2.3,13,1.5,13S0,12.3,0,11.5S0.7,10,1.5,10z" />
                                                        </svg>
                                                    </button>
                                                    <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="customer-context-menu-8">
                                                        <li><a className="dropdown-item" href="#">Edit</a></li>
                                                        <li><a className="dropdown-item" href="#">Duplicate</a></li>
                                                        <li><a className="dropdown-item" href="#">Add tag</a></li>
                                                        <li><a className="dropdown-item" href="#">Remove tag</a></li>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <a href="app-customer.html" className="text-reset">Isabel Williams</a>
                                                        <div className="text-muted mt-n1">williams-isabel@example.com</div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td className="text-nowrap">October 2, 2021</td>
                                            <td>China</td>
                                            <td>Default</td>
                                            <td>
                                                <div className="sa-price">
                                                    <span className="sa-price__symbol">$</span>
                                                    <span className="sa-price__integer">35,762</span>
                                                    <span className="sa-price__decimal">.74</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div className="dropdown">
                                                    <button className="btn btn-sa-muted btn-sm" type="button" id="customer-context-menu-9" data-bs-toggle="dropdown" aria-expanded="false" aria-label="More">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width={3} height={13} fill="currentColor">
                                                            <path d="M1.5,8C0.7,8,0,7.3,0,6.5S0.7,5,1.5,5S3,5.7,3,6.5S2.3,8,1.5,8z M1.5,3C0.7,3,0,2.3,0,1.5S0.7,0,1.5,0 S3,0.7,3,1.5S2.3,3,1.5,3z M1.5,10C2.3,10,3,10.7,3,11.5S2.3,13,1.5,13S0,12.3,0,11.5S0.7,10,1.5,10z" />
                                                        </svg>
                                                    </button>
                                                    <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="customer-context-menu-9">
                                                        <li><a className="dropdown-item" href="#">Edit</a></li>
                                                        <li><a className="dropdown-item" href="#">Duplicate</a></li>
                                                        <li><a className="dropdown-item" href="#">Add tag</a></li>
                                                        <li><a className="dropdown-item" href="#">Remove tag</a></li>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <a href="app-customer.html" className="text-reset">Jacob Lee</a>
                                                        <div className="text-muted mt-n1">lee-jacob@example.com</div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td className="text-nowrap">May 12, 2021</td>
                                            <td>Ukraine</td>
                                            <td>Wholesaler</td>
                                            <td>
                                                <div className="sa-price">
                                                    <span className="sa-price__symbol">$</span>
                                                    <span className="sa-price__integer">911</span>
                                                    <span className="sa-price__decimal">.27</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div className="dropdown">
                                                    <button className="btn btn-sa-muted btn-sm" type="button" id="customer-context-menu-10" data-bs-toggle="dropdown" aria-expanded="false" aria-label="More">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width={3} height={13} fill="currentColor">
                                                            <path d="M1.5,8C0.7,8,0,7.3,0,6.5S0.7,5,1.5,5S3,5.7,3,6.5S2.3,8,1.5,8z M1.5,3C0.7,3,0,2.3,0,1.5S0.7,0,1.5,0 S3,0.7,3,1.5S2.3,3,1.5,3z M1.5,10C2.3,10,3,10.7,3,11.5S2.3,13,1.5,13S0,12.3,0,11.5S0.7,10,1.5,10z" />
                                                        </svg>
                                                    </button>
                                                    <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="customer-context-menu-10">
                                                        <li><a className="dropdown-item" href="#">Edit</a></li>
                                                        <li><a className="dropdown-item" href="#">Duplicate</a></li>
                                                        <li><a className="dropdown-item" href="#">Add tag</a></li>
                                                        <li><a className="dropdown-item" href="#">Remove tag</a></li>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <a href="app-customer.html" className="text-reset">Anna Wilson</a>
                                                        <div className="text-muted mt-n1">wilson-anna@example.com</div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td className="text-nowrap">February 26, 2021</td>
                                            <td>Italy</td>
                                            <td>Wholesaler</td>
                                            <td>
                                                <div className="sa-price">
                                                    <span className="sa-price__symbol">$</span>
                                                    <span className="sa-price__integer">25,486</span>
                                                    <span className="sa-price__decimal">.20</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div className="dropdown">
                                                    <button className="btn btn-sa-muted btn-sm" type="button" id="customer-context-menu-11" data-bs-toggle="dropdown" aria-expanded="false" aria-label="More">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width={3} height={13} fill="currentColor">
                                                            <path d="M1.5,8C0.7,8,0,7.3,0,6.5S0.7,5,1.5,5S3,5.7,3,6.5S2.3,8,1.5,8z M1.5,3C0.7,3,0,2.3,0,1.5S0.7,0,1.5,0 S3,0.7,3,1.5S2.3,3,1.5,3z M1.5,10C2.3,10,3,10.7,3,11.5S2.3,13,1.5,13S0,12.3,0,11.5S0.7,10,1.5,10z" />
                                                        </svg>
                                                    </button>
                                                    <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="customer-context-menu-11">
                                                        <li><a className="dropdown-item" href="#">Edit</a></li>
                                                        <li><a className="dropdown-item" href="#">Duplicate</a></li>
                                                        <li><a className="dropdown-item" href="#">Add tag</a></li>
                                                        <li><a className="dropdown-item" href="#">Remove tag</a></li>
